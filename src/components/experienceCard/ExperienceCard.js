  ...
  return (
    <div className={isDark ? "experience-card-dark":"experience-card"}>
      ...
      <div className="experience-text-details">
        ...
        <p className={isDark ? "subTitle experience-text-desc dark-mode-text":"subTitle experience-text-desc"}>{cardInfo.desc1}<br/></p>
        <p className={isDark ? "subTitle experience-text-desc dark-mode-text":"subTitle experience-text-desc"}>{cardInfo.desc2}</p>
        <ul>
